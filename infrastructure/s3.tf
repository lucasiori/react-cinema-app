...
resource "aws_s3_bucket_ownership_controls" "cinema_app_bucket_ownership_controls" {
...
resource "aws_s3_bucket_acl" "cinema_app_bucket_acl" {
  depends_on = [aws_s3_bucket_ownership_controls.cinema_app_bucket_ownership_controls]
  bucket     = aws_s3_bucket.cinema_app_s3_bucket.id
  acl        = "private"
}

resource "aws_s3_bucket_public_access_block" "cinema_app_bucket_public_block" {
  bucket = aws_s3_bucket.cinema_app_s3_bucket.id
...
resource "aws_s3_bucket_website_configuration" "cinema_app_bucket_website_configuration" {
  bucket = aws_s3_bucket.cinema_app_s3_bucket.id
